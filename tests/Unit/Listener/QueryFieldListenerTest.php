...
#[CoversClass(QueryFieldListener::class)]
#[UsesClass(GraphQLConfig::class)]
final class QueryFieldListenerTest extends TestCase
{
    private QueryFieldListener $listener;
    ...
    protected function setUp(): void
    {
        ...
        $this->listener = new QueryFieldListener(
            $container,
